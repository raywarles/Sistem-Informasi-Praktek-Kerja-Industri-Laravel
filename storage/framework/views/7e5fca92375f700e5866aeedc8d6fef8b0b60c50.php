                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <div class="panel panel-default chartJs">
                                ...
                                <div class="panel-body">
                                    <form action="/industri/update" method="POST" enctype="multipart/form-data">
                                        <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="deskribsi" placeholder="Keterangan"><?php echo e($profile->industri->deskribsi); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Alamat</label>
                                            <textarea class="form-control" name="alamat" placeholder="Alamat"><?php echo e($profile->industri->alamat); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nomor HP</label>
                                            <input type="text" name="nope" class="form-control" id="exampleInputEmail1" value="<?php echo e($profile->industri->nope); ?>" placeholder="Masukan Nomor HP">
                                        </div>
