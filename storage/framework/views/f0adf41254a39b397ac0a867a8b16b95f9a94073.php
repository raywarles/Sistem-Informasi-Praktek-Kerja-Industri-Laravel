		...
		<div id="page-wrapper">
            <div class="header"> 
                        <h1 class="page-header">
                            MANAJEMEN PERIODE <small><?php echo e(Session::get('level')); ?></small>
                        </h1>
                    <ol class="breadcrumb">
                                ...
                                <table id="table_id" class="display">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($period->periode); ?></td>
                                            <td><?php echo e($period->deskribsi); ?></td>
                                            <td><a href="/periode/download/<?php echo e($period->id); ?>"><?php echo e($period->dokumen); ?></a></td>
                                            <td>
                                                <a href="/periode/delete/<?php echo e($period->id); ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
