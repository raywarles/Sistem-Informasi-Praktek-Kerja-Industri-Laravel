        ...
        <div id="page-wrapper">
            <div class="header"> 
                        <h1 class="page-header">
                            DATA PERMOHONAN <small><?php echo e(Session::get('level')); ?></small>
                        </h1>
                    <ol class="breadcrumb">
                                    ...
                                    <table id="table_id3" class="display">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo e($prak->guru->user->nama); ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a  style="float: right;" href="/prakerin/<?php echo e($prak->id); ?>/reject" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
