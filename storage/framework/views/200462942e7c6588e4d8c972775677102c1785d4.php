                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $absens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <tr>
                                            ...
                                            <td><?php echo e($abs->status_a); ?>

                                             <?php if($abs->status_a == 'MENUNGGU' ): ?>
                                             &nbsp; <a href="/absensi/masuk/confirmasi/<?php echo e($abs->id); ?>" class="btn btn-primary"><i class="fa fa-check"></i></a>
                                             <?php endif; ?>
                                            </td>
                                            <td><?php echo e($abs->jam_keluar); ?></td>
                                            <td><?php echo e($abs->status_b); ?>

                                              <?php if($abs->status_b == 'MENUNGGU' ): ?>
                                             &nbsp; <a href="/absensi/keluar/confirmasi/<?php echo e($abs->id); ?>" class="btn btn-primary"><i class="fa fa-check"></i></a>
                                             <?php endif; ?>
                                           </td>
                                            <td><?php echo e($abs->tanggal->format('D, d M Y')); ?></td>                        
                                        </tr>
