                                ...
                                <div class="panel-body">
                                    <form action="/industri/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="deskribsi" placeholder="Keterangan">{{$profile->industri->deskribsi}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Alamat</label>
                                            <textarea class="form-control" name="alamat" placeholder="Alamat">{{$profile->industri->alamat}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nomor HP</label>
                                            <input type="text" name="nope" class="form-control" id="exampleInputEmail1" value="{{$profile->industri->nope}}" placeholder="Masukan Nomor HP">
                                        </div>
