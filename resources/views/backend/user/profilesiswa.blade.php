                                ...
                                <div class="panel-body">
                                    <form action="/siswa/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nis" class="form-control" id="exampleInputEmail1" placeholder="Masukan NIS" value="{{$profile->siswa->nis}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nope" class="form-control" id="exampleInputEmail1" value="{{$profile->siswa->nope}}" placeholder="Masukan Nomor HP">
                                        </div>
                                        <div class="form-group">
