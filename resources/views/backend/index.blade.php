		...
		<div id="page-wrapper">
            <div class="header"> 
                        <h1 class="page-header">
                            HOME <small>{{Session::get('level')}}</small>
                        </h1>
                    <ol class="breadcrumb">
                      <li><a href="#">Home</a></li>
            ...
            <div id="page-inner">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$per->periode}}</td>
                                            <td>{{$per->deskribsi}}</td>
                                            <td><a href="/periode/download/{{$per->id}}">{{$per->dokumen}}</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                ...
                <div class="row">
					  <div class="col-md-8">
					     <div class="panel panel-default">
						<div class="panel-heading">
						 		<p align="justify">Hello, <font color="red">{{Session::get('nama')}}</font> selamat datang di Sistem Infomrasi Praktek Kerja Industri, kamu berhasil login sebagai <font color="red">{{Session::get('level')}}</font>. </p>
						</div>        									  
							<div class="panel-body"> 
